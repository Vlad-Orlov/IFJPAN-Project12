...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D1MAX2_01", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D1MAX2_12", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D2MAX2_02", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D1MAX3_01", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D1MAX3_12", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTLONG_D2MAX3_02", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX1_01", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX1_12", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D2MAX1_02", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX2_01", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX2_12", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D2MAX2_02", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX3_01", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D1MAX3_12", 'F' );
   // dataloader->AddVariable( "tau_TRKISOBDTVELO_D2MAX3_02", 'F' );
   // dataloader->AddVariable( "tau_ID", 'F' );
   // dataloader->AddVariable( "tau_OWNPV_X", 'F' );
   // dataloader->AddVariable( "tau_OWNPV_Y", 'F' );
   // dataloader->AddVariable( "tau_OWNPV_Z", 'F' );
   // dataloader->AddVariable( "tau_OWNPV_CHI2", 'F' );
   ...
   // dataloader->AddVariable( "mu1_E", 'F' );
   ...
   // dataloader->AddVariable( "mu2_M", 'F' );
   // dataloader->AddVariable( "mu2_E", 'F' );
   ...
   // dataloader->AddVariable( "mu3_M", 'F' );
   // dataloader->AddVariable( "mu3_E", 'F' );
   ...
   // dataloader->AddVariable( "nTracks", 'F' );
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=565:nTrain_Background=565:SplitMode=Random:NormMode=NumEvents:!V" );
   // ### Book MVA methods
   //
   ...
   if (Use["PDEFoam"])
      factory->BookMethod( dataloader, TMVA::Types::kPDEFoam, "PDEFoam",
                           // "!H:!V:SigBgSeparate=F:TailCut=0.001:VolFrac=0.0666:nActiveCells=500:nSampl=565:nBin=5:Nmin=100:Kernel=None:Compress=T" );
